...
func TenantIdIsNil() predicate.Queue {
	return predicate.Queue(sql.FieldIsNull(FieldTenantId))
}

// TenantIdNotNil applies the NotNil predicate on the "tenantId" field.
func TenantIdNotNil() predicate.Queue {
	return predicate.Queue(sql.FieldNotNull(FieldTenantId))
}
